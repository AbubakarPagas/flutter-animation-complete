...
class CardSwipeDemo extends StatefulWidget {
  static const String routerName = 'mics/card_swipe';
  @override
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
            ...
            image: DecorationImage(
                image: AssetImage(imageAssetName), fit: BoxFit.cover)),
      ),
    );
  }
}
...
class _SwipeableCardState extends State<SwipeableCard>
  ...
  void initState() {
    ...
    _animation =
        _controller.drive(Tween<Offset>(begin: Offset.zero, end: Offset(1, 0)));
  }
